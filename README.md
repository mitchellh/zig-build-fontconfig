# Fontconfig built with Zig

This project builds [Fontconfig](https://gitlab.freedesktop.org/fontconfig/fontconfig.git)
...
.{
    ...
    .dependencies = .{
        .fontconfig = .{
            .url = "https://github.com/mitchellh/zig-build-fontconfig/archive/<git-ref-here>.tar.gz",
